...
describe('CachedImage', () => {
  it('renders with source prop', () => {
    const { toJSON } = render(<CachedImage source={{ uri: 'https://example.com/image.jpg' }} />);
  ...
  it('renders loader when showLoader is true', () => {
    const { UNSAFE_getAllByType } = render(
      <CachedImage source={{ uri: 'https://example.com/image.jpg' }} showLoader={true} />,
    );
  ...
  it('does not render loader when showLoader is false', () => {
    const { UNSAFE_queryAllByType } = render(
      <CachedImage source={{ uri: 'https://example.com/image.jpg' }} showLoader={false} />,
    );
  ...
  it('renders with local image source', () => {
    const { toJSON } = render(<CachedImage source={require('../../../../assets/icon.png')} />);
