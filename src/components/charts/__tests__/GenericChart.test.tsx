...
describe('GenericChart', () => {
    ...
    describe('Pie chart rendering', () => {
        ...
        it('renders pie chart with data', () => {
            const { getByText } = render(
                <GenericChart data={pieData} type="pie" title="Pie Chart" />,
            );
    ...
    describe('Bar chart rendering', () => {
        ...
        it('renders bar chart with title', () => {
            const { getByText } = render(
                <GenericChart data={barData} type="bar" title="Bar Chart" />,
            );
        ...
        it('renders bar chart with custom height', () => {
            const { toJSON } = render(
                <GenericChart data={barData} type="bar" height={300} />,
            );
    ...
    describe('Props handling', () => {
        it('uses default height when not specified', () => {
            const { toJSON } = render(
                <GenericChart data={[{ label: 'Test', value: 100 }]} type="bar" />,
            );
